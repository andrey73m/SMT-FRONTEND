...
const IconoNotificacion = ({ pendiente, className, ...props }: Props) => {
  if (pendiente)
    return (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`p-1 motion-reduce:animate-bounce ${className}`}>
